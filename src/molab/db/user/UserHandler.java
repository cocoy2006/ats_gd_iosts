...
//			return false;
	...
	/**
	 * 0:do nothing, 1:update lefttime, 2:logout, -1:error*/
	public int updateLefttime(String username, String server, String serialNumber, int lefttime) {
		...
		try {
			...
			if(r == null) { // no reservations on device now
				...
				if(!username.equals(u.getUsername())) { // other user's reservation is coming, force sign out current user
					// logout
					return 2;
				}
			}
