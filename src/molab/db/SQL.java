...
//	public static String SELECT_USERS_WITH_USERNAME = "FROM User WHERE username LIKE '%%s%'";
	public static String SELECT_USER_INFO = "FROM User WHERE id='%s'";
	public static String SELECT_ALL_USERS = "FROM User";
	public static String CHECK_USER = "FROM User WHERE username='%s' AND password='%s'";
	...
	public static String SELECT_IOS_DEVICES = "FROM Device WHERE os LIKE 'iOS %'";
	...
	public static String SELECT_QUERY_LOGS = "FROM Log WHERE user_id='%s' AND device_id='%s' AND time BETWEEN '%s' AND '%s'";
	public static String SELECT_ALL_LOGS = "FROM Log WHERE time BETWEEN '%s' AND '%s'";
